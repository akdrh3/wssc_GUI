 ...
 * @author ryana
 */
public class Small_Leak_Frame_Monthly extends javax.swing.JFrame {

    /**
     * Creates new form Small_Leak_Frame_Monthly
     */
    public Small_Leak_Frame_Monthly() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pngs/Small Leak - Monthly.png"))); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Small_Leak_Frame_Monthly.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
